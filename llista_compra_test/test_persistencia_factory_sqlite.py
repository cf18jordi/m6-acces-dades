...
from Persistencia_usuari_sqlite import Persistencia_usuari_sqlite


class test_Persistencia_factory_sqlite(unittest.TestCase):
    ...
    def test_get_Persistencia_usuari_factory(self):
        ...
        assert type(p_usuari) is Persistencia_usuari_sqlite
        return
